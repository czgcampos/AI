	...
	private class Comprarproduto extends OneShotBehaviour {
		public void action() {
			...
			try {
				...
				// Get Agent Name: "Customer1", "Customer2" or "Customer3" and save in String agentname
				...
				if (results.length > 0) {
					//System.out.println("CUSTOMER -> Agent " + getLocalName() + " found!");
					...
					//System.out.println("CUSTOMER -> Agent " + getLocalName() + " not found!");
				}
